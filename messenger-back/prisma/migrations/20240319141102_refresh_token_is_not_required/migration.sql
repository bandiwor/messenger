...
INSERT INTO "new_Account" ("email", "id", "login", "passwordHash", "profileCreated", "refreshToken", "telephone", "timeCreate") SELECT "email", "id", "login", "passwordHash", "profileCreated", "refreshToken", "telephone", "timeCreate" FROM "Account";
DROP TABLE "Account";
